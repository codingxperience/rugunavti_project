...
export function ApplicationStatusNotice({
  ...
  return (
    <section className="relative overflow-hidden rounded-[28px] border border-white/75 bg-white/42 p-4 shadow-[0_26px_80px_-58px_rgba(17,17,17,0.6)] ring-1 ring-black/5 backdrop-blur-2xl">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_12%_0%,rgba(253,224,71,0.28),transparent_34%),linear-gradient(135deg,rgba(255,255,255,0.72),rgba(255,255,255,0.24))]" />
      ...
      <Link
        ...
        className="mt-4 inline-flex items-center justify-center rounded-full border border-[#e0c52b] bg-[var(--color-accent)] px-4 py-2 text-sm font-bold text-[var(--color-ink)] shadow-[0_18px_38px_-28px_rgba(17,17,17,0.45)] transition hover:-translate-y-0.5 hover:bg-[#f8d92d]"
      >
        Track application
      </Link>
      </div>
