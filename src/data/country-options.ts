export type CountryOption = { iso2: string; name: string; dialCode: string };

export const countryOptions = [
  { iso2: "AF", name: "Afghanistan", dialCode: "+93" },
  { iso2: "AX", name: "Aland Islands", dialCode: "+35818" },
  ...
  { iso2: "TF", name: "French Southern and Antarctic Lands", dialCode: "+262" },
  ...
  { iso2: "SJ", name: "Svalbard and Jan Mayen", dialCode: "+4779" },
  ...
  { iso2: "UM", name: "United States Minor Outlying Islands", dialCode: "" },
...
export const nationalityOptions = countryOptions.map((country) => country.name);
